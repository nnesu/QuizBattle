...
public partial class SourceMaterial : ContentPage
{
    ...
    private async void OnDifficultyChanged(object? sender, CheckedChangedEventArgs e)
    {
    ...
    private async void ToggleDropdownLayout(object? sender, EventArgs e)
    {
        await AudioService.PlayButtonClickAsync();
    ...
    private async void CloseSetupPopup(object? sender, EventArgs e)
    {
        await AudioService.PlayButtonClickAsync();
    ...
    private async void OpenGenerateDeckModal(object? sender, EventArgs e)
    {
        await AudioService.PlayButtonClickAsync();
    ...
    private async void OpenImportDeckModal(object? sender, EventArgs e)
    {
        await AudioService.PlayButtonClickAsync();
